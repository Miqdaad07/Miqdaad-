...
export default function Services() {
  const services = [
    ...
    },
    {
      ...
      description: 'Bespoke aesthetic systems, wireframes, and high-fidelity interactive designs. I create elite, modern digital interfaces that convey luxury, project immense authority, and elevate your brand image.',
      icon: <Palette size={24} className="text-accent" />,
      tag: 'High-Fidelity Design'
    },
    {
      title: 'Modern Website Redesign',
      description: 'Transform legacy, slow, or template-based websites into cutting-edge, high-conversion engines. I rewrite core layers from scratch to supercharge loading times and align your aesthetic with modern standards.',
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <div className="max-w-xl mb-20">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-accent/10 border border-accent/20 rounded-full text-accent mb-4">
            ...
            <span className="font-mono text-[9px] md:text-[10px] uppercase tracking-[0.15em] font-bold">What I Offer</span>
          </div>
          ...
          <p className="text-muted text-[14px] md:text-[15px] mt-4 leading-relaxed font-light">
            I don't use generic page templates or slow, bloated builders. Every layer is carefully written from scratch, ensuring peak technical performance and a completely unique aesthetic.
          </p>
        </div>
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <h3 className="text-[18px] md:text-[20px] font-display font-bold text-foreground group-hover:text-accent transition-colors">
                  {service.title}
                </h3>
