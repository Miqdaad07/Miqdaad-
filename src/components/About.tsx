...
export default function About() {
  const values = [
    { 
      ...
      desc: 'I write lightweight, zero-bloat modular code. Your site loads instantaneously, directly improving SEO rankings and conversion rates.', 
    ...
    { 
      ...
      desc: 'I merge high-fidelity luxury digital designs with interactive micro-details to make your brand unforgettable.', 
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <div className="mb-20 max-w-xl">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-accent/10 border border-accent/20 rounded-full text-accent mb-4">
            ...
            <span className="font-mono text-[9px] md:text-[10px] uppercase tracking-[0.15em] font-bold">About Miqdaad</span>
          </div>
          <h2 className="text-[32px] md:text-[45px] font-display font-extrabold tracking-tight text-foreground leading-tight">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          >
            <div className="p-6 md:p-8 rounded-2xl bg-card border border-accent/15 relative overflow-hidden group">
              ...
              <h3 className="text-[20px] md:text-[22px] font-display font-bold mb-4 text-foreground">My Mission</h3>
              <p className="text-[14px] md:text-[15px] text-muted leading-relaxed font-light">
                I believe that your website should not just be an "online business card." It is your most powerful marketing officer, your sales coordinator, and your brand's ultimate digital authority representation.
              </p>
              <p className="text-[14px] md:text-[15px] text-muted leading-relaxed font-light mt-4">
                I craft beautiful, lightning-speed digital systems for commercial businesses, luxury brands, and specialized foundations. By bridging strict technical engineering with premium visual designs, I help my clients dominate their markets and trigger high-volume conversions.
              </p>
            </div>
            ...
            <div className="flex gap-4 p-5 rounded-2xl bg-card border border-card-border/60 relative overflow-hidden">
              ...
              <div>
                <p className="text-[13px] md:text-[14px] font-medium text-foreground italic leading-relaxed">
                  "I don't build generic web pages. I program highly structured digital assets that load instantaneously and drive continuous growth."
                </p>
                <p className="text-[10px] font-mono text-accent/80 uppercase tracking-widest mt-2.5">- Dawodu Miqdaad</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <h3 className="text-[20px] md:text-[22px] font-display font-bold text-foreground text-left pl-1">
              Why Global Brands Choose Me
            </h3>
              ...
              {values.map((val, index) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-[14px] md:text-[15px] font-display font-bold text-foreground">{val.title}</span>
                  </div>
